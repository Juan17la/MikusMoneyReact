              ...
              {step === 1 ? (
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-contrast/40 mt-1">
                      The recipient's public account code
                    </p>
                  </div>
                </>
              ) : (
                <>
                  <div className="bg-black-20/30 rounded-xl p-4 border border-white-8/30 space-y-3 mb-2">
                    <div>
                      <p className="text-contrast/70 text-xs mb-1">Transfer Amount</p>
                      <p className="text-2xl font-bold text-accent">${amount.toFixed(2)}</p>
                    </div>
                    <div className="border-t border-white-8/20 pt-3">
                      <p className="text-contrast/70 text-xs mb-1">To Account</p>
                      <p className="text-sm font-mono text-contrast/80">{receiver}</p>
                    </div>
                  </div>
