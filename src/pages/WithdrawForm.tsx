...
import { withdraw } from "../api/transactionsService";
import mikusWithdrawsMoney from "../assets/mikuWithdrawsMoney.png";
        ...
        <div className="w-full max-w-md bg-linear-to-b from-white-2 to-black-8 rounded-3xl shadow-outer border border-accent-alpha overflow-hidden">
          ...
          <div className="relative pt-8 pb-6 px-6 text-center">
            <div className="absolute -top-1 right-4 opacity-40">
              <div className="w-24 h-24 rounded-full bg-red-500/5 blur-3xl"></div>
            </div>
            <img
              src={mikusWithdrawsMoney}
              alt="sticker"
              ...
              {step === 1 ? (
                ...
                <>
                  <div className="bg-black-20/30 rounded-xl p-4 mb-2 border border-white-8/30">
                    <p className="text-contrast/70 text-xs mb-2">Withdrawal Amount</p>
